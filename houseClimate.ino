...
float getConsumo(int luminosidade)  {
  float x;
  
  if (luminosidade >= 100 && luz >= 700) {
   x=map(luminosidade,luminosidade,100,0,255);
  } else if (luminosidade >= 100 && luminosidade < 700) {
   x=map(luminosidade,700,100,0,255);
  } 
  else if (luminosidade > 100) {
    x=map(luminosidade,700,luminosidade,0,255);    
  }
...
void Test() {
  ...
  if (luz >= 100 && luz >= 700) {
   x=map(luz,luz,100,0,255);
  } else if (luz >= 100 && luz < 700) {
   x=map(luz,700,100,0,255);
  } 
  else if (luz > 100) {
    x=map(luz,700,luz,0,255);    
  }
